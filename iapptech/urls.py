...
urlpatterns = [
   ...
   # url(r'^testapp/$', views.testapp),
	...
	# for webservice
     ...
     url(r'^getUserProfile/$', soapboxwebservice.getUserProfile),
     url(r'^editProfile/$', soapboxwebservice.editProfile),
     url(r'^getCommentPostList/$', soapboxwebservice.getCommentPostList),
     url(r'^getActivityList/$', soapboxwebservice.getActivityList),
