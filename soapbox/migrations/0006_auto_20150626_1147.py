...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('soapbox', '0005_auto_20150626_1143'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(related_query_name=b'postshare', related_name='sharepost', to='soapbox.Posts')),
            ],
        ),
        migrations.CreateModel(
            name='UserFollowers',
        ...
        migrations.AddField(
            model_name='chatmod',
            name='juser',
            field=models.ForeignKey(related_query_name=b'jusr', related_name='jusers', to='soapbox.Users'),
        ),
        migrations.AddField(
